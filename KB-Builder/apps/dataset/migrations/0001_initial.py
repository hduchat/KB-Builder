    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_child', models.CharField(choices=[('0', '子知识库'), ('1', '父知识库')], default='0', max_length=1, verbose_name='是否为子知识库')),
                ('child_id', models.UUIDField(blank=True, null=True, verbose_name='子知识库id')),
                ('app_id', models.UUIDField(blank=True, null=True, verbose_name='应用id'))
            ],
            options={
                'db_table': 'dataset',
            },
