...
class SplitModel:
    ...
    def parse(self, text: str):
        ...
        if 'Recursive' in self.content_level_pattern:
            result = self.parse_recursively(text)
        else:
            result = self.parse_by_pattern(text)
    ...
    def parse_recursively(self, text: str):
        ...
        result = [{'title': "", 'content': text} for text in split_texts]
        return result

    def parse_by_pattern(self, text):
