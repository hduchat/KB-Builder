...
class DataSet(AppModelMixin):
    ...
    type = models.CharField(verbose_name='类型', max_length=1, choices=Type.choices,
                            default=Type.base)
    meta = models.JSONField(verbose_name="元数据", default=dict)
    type_child = models.CharField(verbose_name='是否为子知识库',max_length=1, choices=Type.choices, 
                                  default=Type.base)# 新增的字段
    child_id = models.UUIDField(max_length=128,blank=True, null=True, verbose_name='子知识库id')# 新增的字段
    app_id = models.UUIDField(max_length=128, blank=True, null=True, verbose_name="应用id")
