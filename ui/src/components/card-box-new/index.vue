    ...
    <div class="card-header">
      <slot name="header">
        <div class="title flex align-center">
          <slot name="icon">
            <AppAvatar v-if="showIcon" backgroundColor="#1C9985" class="mr-12 avatar-light" shape="square" :size="32">
              <img src="@/assets/icon_document.svg" style="width: 58%" alt="" />
            </AppAvatar>
          </slot>
          <auto-tooltip :content="title" style="width: 65%;font-size: 14px;font-weight: 600;">
            {{ title }}
          </auto-tooltip>
        </div>
      </slot>
