<template>
  <el-dialog v-model="aboutDialogVisible" class="about-dialog">
    ...
    <div class="about-ui">
      <el-card shadow="hover" class="mb-16" @click="toUrl('https://github.com/hduchat/KB-Builder')">
      ...
      <el-card shadow="hover" class="mb-16" @click="toUrl('https://github.com/hduchat/KB-Builder/wiki/%E4%BA%A7%E5%93%81%E4%BB%8B%E7%BB%8D')">
        <div class="flex align-center cursor">
          <AppIcon iconName="app-reading" class="mr-16 ml-8" style="font-size: 24px"></AppIcon>
          <span>{{ $t("layout.topbar.wiki") }}</span>
        </div>
      </el-card>
      <el-card shadow="hover" class="mb-16" @click="toUrl('https://github.com/hduchat/KB-Builder/wiki')">
        <div class="flex align-center cursor">
